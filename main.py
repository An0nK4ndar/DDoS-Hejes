...
choice = str(input(" Continue Ddos?(y/n):"))
...
def run():
	...
	i = random.choice(("[ATTACK.!!ATTACK.!!]","[ATTACK.!!ATTACK.!!]","[ATTACK.!!ATTACK.!!]"))
	...
	while True:
		...
		try:
			...
			print(i +" PACKETS FROM K4NDAR!!!")

		except:

			s.close()

			print("[MAMPUS] PACKETS K4NDAR!!!")
...
def exit_gracefully(signum, frame):
    ...
    try:
        ...
        exitc = str(input(" Kenapa Tutup? Main Lagi Lah <3 ?:"))
